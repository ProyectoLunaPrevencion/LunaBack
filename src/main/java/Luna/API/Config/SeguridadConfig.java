    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers(HttpMethod.POST, "/api/postsPizarra").hasAnyRole("PROFESOR", "ORIENTACION")
                .requestMatchers(HttpMethod.DELETE, "/api/postsPizarra/*").hasAnyRole("PROFESOR", "ORIENTACION")
                .requestMatchers(HttpMethod.PUT, "/api/postsPizarra/*").hasAnyRole("PROFESOR", "ORIENTACION")              
