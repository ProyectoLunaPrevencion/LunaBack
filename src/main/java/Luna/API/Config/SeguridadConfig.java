    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers(HttpMethod.POST, "/api/postsPizarra").hasRole("PROFESOR")
                .requestMatchers(HttpMethod.DELETE, "/api/postsPizarra/*").hasRole("PROFESOR") 
                .requestMatchers(HttpMethod.PUT, "/api/postsPizarra/*").hasRole("PROFESOR")              
